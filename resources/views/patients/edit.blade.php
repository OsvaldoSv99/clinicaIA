                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('patients.update', $patient) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="dob" class="block mt-1 w-full" type="date" name="dob" :value="old('dob', $patient->dob)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="address" name="address" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('address', $patient->address) }}</textarea>
                            <x-input-error :messages="$errors->get('address')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="medical_history" :value="__('Historial Médico')" />
                            <textarea id="medical_history" name="medical_history" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('medical_history', $patient->medical_history) }}</textarea>
